                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="item {{$index ==0 ? 'active' :''}}">
                            <img src="{{$urun->detay->urun_resmi!=null ? asset('uploads/urunler/'.$urun->detay->urun_resmi) :
                                    'http://via.placeholder.com/400x400?text=UrunResmi'}}" class="img-responsive" style="min-width: 100%">                                 <div class="carousel-caption">
                                {{$urun->urun_adi}}
                            </div>
                        </div>
                @endforeach
                ...
                <div class="panel panel-default" id="sidebar-product">
                    ...
                    <div class="panel-body">
                        <a href="{{route('urun',$urun_gunun_firsati->slug)}}">
                            <img src="{{$urun_gunun_firsati->detay->urun_resmi!=null ? asset('uploads/urunler/'.$urun_gunun_firsati->detay->urun_resmi) :
                                    'http://via.placeholder.com/400x400?text=UrunResmi'}}" class="img-responsive" style="min-width: 100%">                            {{$urun_gunun_firsati->urun_adi}}
                        </a>
                    </div>
                </div>
            </div>
