                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control telefon" name="telefon" value="{{$kullanici_detay->telefon}}"  id="telefon" >
                            </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="ceptelefonu" value="{{$kullanici_detay->ceptelefon}}"  id="ceptelefonu" >
                            </div>
