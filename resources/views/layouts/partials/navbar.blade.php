<nav class="navbar navbar-default">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <form class="navbar-form navbar-left" action="{{'ara'}}" method="post">
                {{csrf_field()}}
            ...
            <ul class="nav navbar-nav navbar-right">
                @auth <li><a href="{{route('sepet')}}"><i class="fa fa-shopping-cart"></i> Sepet <span class="badge badge-theme">{{Cart::count()}}</span></a></li>@endauth
                @guest
