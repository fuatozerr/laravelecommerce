...
<form method="post" action="{{route('yonetim.urun.kaydet',@$entry->id)}}" enctype="multipart/form-data">
    ...
    <h2 class="sub-header">
        Ürün {{@$entry->id>0 ? "Güncelle" :"Kaydet"}}
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="urun_adi" name="urun_adi" placeholder="Adınız" value="{{old('urun_adi',$entry->urun_adi)}}">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <textarea class="form-control" id="aciklama" name="aciklama"    > {{old('aciklama',$entry->aciklama)}} </textarea>
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="checkbox">
        <label>
            ...
            <input type="checkbox" name="goster_slider" value="1" {{old('goster_slider',$entry->detay->goster_slider ? 'checked' : '')}}> Slider da gösterilsin mi?
        </label>
    </div>
    <div class="checkbox">
        <label>
            <input type="hidden" name="goster_gunun_firsati" value="0">
            <input type="checkbox" name="goster_gunun_firsati" value="1" {{old('goster_gunun_firsati',$entry->detay->goster_gunun_firsati ? 'checked' : '')}}> Günün Fırsatın da gösterilsin mi?
        </label>
    </div>
    ...
    <div class="checkbox">
        <label>
            ...
            <input type="checkbox" name="goster_one_cikan" value="1" {{old('goster_one_cikan',$entry->detay->goster_one_cikan ? 'checked' : '')}}> Öne Çıkarılsın mı?
        </label>
    </div>
    <div class="checkbox">
        <label>
    ...
    <div class="checkbox">
        <label>
            ...
            <input type="checkbox" name="goster_indirimli" value="1" {{old('goster_indirimli',$entry->detay->goster_indirimli ? 'checked' : '')}}> İndirimli mi ?
        </label>
    </div>
